...
## pubsub_bigbang_stm32aws

```
pip install awsiotsdk
```
- `run_api.sh` 스크립트를 실행
- `pubsub.py` 기반 `task_flask.py` API 서버를 위한 브로커
- [AWS IoT Core > Secure > Certificates](https://ap-northeast-2.console.aws.amazon.com/iot/home?region=ap-northeast-2#/certificatehub) 2개 인증서 모두 active 필요.
  - 0556a603... STM32 <-> AWS
  - 42842747... AWS <-> Broker
- AWS MQTT Message 확인
  - [AWS IoT Core > Test](https://ap-northeast-2.console.aws.amazon.com/iot/home?region=ap-northeast-2#/test) Subscribe to a topic `dt/stm32l475e/sensor-data/topic` 
