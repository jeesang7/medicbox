...
#define AI_NETWORK_MODEL_SIGNATURE     "9df262603fbb2db4bb0958a2dfd8abd3"
...
#define AI_TOOLS_DATE_TIME   "Thu Dec 31 22:48:38 2020"
...
AI_STATIC ai_array dense_41_bias_array;   /* Array #0 */
AI_STATIC ai_array dense_41_weights_array;   /* Array #1 */
AI_STATIC ai_array dense_40_bias_array;   /* Array #2 */
AI_STATIC ai_array dense_40_weights_array;   /* Array #3 */
AI_STATIC ai_array conv1d_36_bias_array;   /* Array #4 */
AI_STATIC ai_array conv1d_36_weights_array;   /* Array #5 */
AI_STATIC ai_array conv1d_35_bias_array;   /* Array #6 */
AI_STATIC ai_array conv1d_35_weights_array;   /* Array #7 */
AI_STATIC ai_array input_0_output_array;   /* Array #8 */
AI_STATIC ai_array conv1d_35_output_array;   /* Array #9 */
AI_STATIC ai_array conv1d_36_output_array;   /* Array #10 */
AI_STATIC ai_array dense_40_output_array;   /* Array #11 */
AI_STATIC ai_array dense_40_nl_output_array;   /* Array #12 */
AI_STATIC ai_array dense_41_output_array;   /* Array #13 */
AI_STATIC ai_array dense_41_nl_output_array;   /* Array #14 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor dense_41_bias;   /* Tensor #0 */
AI_STATIC ai_tensor dense_41_weights;   /* Tensor #1 */
AI_STATIC ai_tensor dense_40_bias;   /* Tensor #2 */
AI_STATIC ai_tensor dense_40_weights;   /* Tensor #3 */
AI_STATIC ai_tensor conv1d_36_bias;   /* Tensor #4 */
AI_STATIC ai_tensor conv1d_36_weights;   /* Tensor #5 */
AI_STATIC ai_tensor conv1d_35_bias;   /* Tensor #6 */
AI_STATIC ai_tensor conv1d_35_weights;   /* Tensor #7 */
AI_STATIC ai_tensor input_0_output;   /* Tensor #8 */
AI_STATIC ai_tensor conv1d_35_output;   /* Tensor #9 */
AI_STATIC ai_tensor conv1d_36_output;   /* Tensor #10 */
AI_STATIC ai_tensor conv1d_36_output0;   /* Tensor #11 */
AI_STATIC ai_tensor dense_40_output;   /* Tensor #12 */
AI_STATIC ai_tensor dense_40_nl_output;   /* Tensor #13 */
AI_STATIC ai_tensor dense_41_output;   /* Tensor #14 */
AI_STATIC ai_tensor dense_41_nl_output;   /* Tensor #15 */
